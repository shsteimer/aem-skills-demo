...
- **Production Preview**: `https://main--aem-skills-demo--shsteimer.aem.page/`
- **Production Live**: `https://main--aem-skills-demo--shsteimer.aem.live/`
- **Feature Preview**: `https://{branch}--aem-skills-demo--shsteimer.aem.page/`
...
3. Open a pull request to merge changes to `main`
   - **REQUIRED:** Include preview link in PR description: `https://{branch}--aem-skills-demo--shsteimer.aem.page/{path}`
